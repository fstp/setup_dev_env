...
-- Snacks Terminal
keymap.set("n", "<C-q>", ":lua require('snacks').terminal(nil, {win = {position = 'bottom', width = 0.6}})<CR>",
  { desc = "Open Snacks Terminal" })
keymap.set("n", "<leader>i", ":lua require('snacks').terminal(nil, {win = {position = 'bottom', width = 0.6}})<CR>",
  { desc = "Open Snacks Terminal" })
